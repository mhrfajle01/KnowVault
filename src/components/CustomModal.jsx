...
const CustomModal = () => {
  ...
  const { isOpen, title, message, type, onConfirm } = modalConfig;
  ...
  return (
    ...
    >
      ...
      >
        <div 
            className="card-header text-white border-0 text-center py-4" 
            style={{ 
        ...
        <div className="card-body p-4 text-center">
          ...
          <div className="d-flex justify-content-center gap-2">
            ...
            <button 
                ...
                style={{ background: type === 'danger' ? '#ff6b6b' : '#4dabf7' }} 
                onClick={handleConfirm}
            >
                {type === 'danger' ? 'Yes, Delete' : 'Okay'}
            </button>
          </div>
        </div>
      </div>
