...
export const localKnowledge = [
  ...
  // --- Fun & Dynamic ---
  { keywords: ['time', 'clock', 'what time'], answer: "dynamic_time", action: 'tell_time' }, // Special handling
...
export const findLocalAnswer = (query) => {
  ...
  // 1. Check for exact keywords matches
  ...
  if (match) {
      ...
      let soundEffect = 'info'; // Default sound
      ...
      if (match.answer === 'dynamic_time') {
          ...
          soundEffect = 'success'; // Actions usually imply success
      }
